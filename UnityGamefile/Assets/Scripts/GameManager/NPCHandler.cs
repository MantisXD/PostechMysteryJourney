...
public class NPCHandler : MonoBehaviour {
    ...
    Dictionary<string, Sprite> StandingNPCSpirteCache = new Dictionary<string, Sprite>();
    ...
    void SetNPCSpriteCache()
    {
        ...
        StreamReader NPCMapReader = new StreamReader(NPCMaplocation, Encoding.UTF8);

        //대응표에 맞게 스탠딩 NPC의 그림을 불러옵니다.
        while ((NPCMaptext = NPCMapReader.ReadLine()) != null)
        {
            string[] t = NPCMaptext.Split(' ');
            string keyword = t[0];
            int index;
